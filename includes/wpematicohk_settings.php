						...
						<div id="side-info-column" class="inner-sidebar">
							<div id="side-sortables" class="meta-box-sortables ui-sortable">
								<div class="postbox inside">
									...
									<div class="inside">
										<p id="left1" onmouseover="jQuery(this).css('opacity', 0.9);" onmouseout="jQuery(this).css('opacity', 0.5);" style="text-align:center;opacity: 0.5;">
											<a href="https://www.wpematico.com/" target="_Blank" title="Take a look at all WPeMatico features in its website.">
										...
										<p></p>
										<p style="text-align: center;"><?php _e('If you like it and want to thank, you can write a 5 star review on Wordpress.', 'wpematico'); ?><br />
											<?php _e('We really appreciate it..', 'wpematico'); ?></p>
								...
								<div class="postbox inside">
									...
									<h3 class="handle"><?php _e('Empowering with extensions', 'wpematico-custom-hooks'); ?></h3>
									<div class="inside">
										<a href="https://etruel.com/downloads/wpematico-premium-package/" target="_Blank" title="Go to new WPeMatico WebSite">
											<img style="width: 100%;" src="<?php echo WPeMatico :: $uri; ?>/images/wpematico-premium-200x100.png" title="">
										</a><br />
										<p style="text-align: center;"><?php _e('The link below will take you to the best discount with all WPeMatico extensions.', 'wpematico-custom-hooks'); ?>
										</p>
										<p></p>
										<p style="text-align: center;">
